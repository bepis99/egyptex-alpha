...
const Card = styled.div`
  ${tw`flex flex-col mx-auto max-w-xs items-center px-6 py-10 border-2 border-dashed border-yellow-500 rounded-lg mt-12`}
  .imageContainer {
  ...
  .title {
    ${tw`mt-2 font-bold text-xl leading-none text-yellow-700`}
  }
  ...
  return (
    <Container>
      <ThreeColumnContainer>
        <Heading>Our Professional <span tw="text-yellow-700">Services</span></Heading>
        {cards.map((card, i) => (
          <Column key={i}>
            <Card>
