...
const Details = tw.div`p-6 rounded border-2 border-t-0 rounded-t-none border-dashed border-yellow-200 flex-1 flex flex-col items-center text-center lg:block lg:text-left`;
...
export default ({
  subheading = "Blog",
  heading = <>We Love <span tw="text-yellow-700">Writing.</span></>,
