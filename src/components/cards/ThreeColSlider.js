...
export default () => {
  ...
  useEffect(()=>{
    Axios.get(`${BASE_API_URL}/api/hotelinfo`).then((response)=>{
      ...
      <Content>
        ...
        <CardSlider ref={setSliderRef} {...sliderSettings}>
          {HotelInfoList.map((val, index) => (
            <Card key={index}>
              <CardImage imageSrc={val.hotel_imgsrc} />
              <TextInfo>
                <TitleReviewContainer>
                  <Title>{val.hotel_title}</Title>
                  <RatingsInfo>
                    <StarIcon />
                    <Rating>{val.hotel_rating}</Rating>
                  </RatingsInfo>
                </TitleReviewContainer>
                <SecondaryInfoContainer>
                  <IconWithText>
                    ...
                    <Text>{val.hotel_location}</Text>
                  </IconWithText>
                  <IconWithText>
                    <IconContainer>
                      <PriceIcon />
                    </IconContainer>
                    <Text>{val.hotel_price}</Text>
                  </IconWithText>
                </SecondaryInfoContainer>
                <Description>{val.hotel_desc}</Description>
              </TextInfo>
