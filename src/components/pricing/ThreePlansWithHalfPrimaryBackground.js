...
const PlanFeatures = styled.ul`
  ...
  .feature {
    ...
    .icon {
      ${tw`w-6 h-6 text-yellow-700 flex-shrink-0`}
    }
    .text {
...
const ActionButton = styled(PrimaryButtonBase)`
  ${tw`block text-center text-sm font-semibold tracking-wider w-full text-gray-100 bg-yellow-700 px-6 py-4 rounded hover:bg-yellow-900 focus:shadow-outline focus:outline-none transition-colors duration-300`}
`;
